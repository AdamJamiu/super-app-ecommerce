const AppLoading = () => {
    return (
        ...
        <div className="w-screen h-screen flex flex-col justify-center items-center rounded-md">
            <svg className="animate-spin fill-red-900"
                xmlns="http://www.w3.org/2000/svg" height="60" viewBox="0 -960 960 960" width="60">
                <path
