      ...
      <div className="max-w-5xl flex flex-col justify-center items-center h-full w-full">
        <div className="mt-10 flex flex-col justify-center gap-5 items-centers h-full bg-white">
          ...
          <p className="text-secondary text-lg">
            Just Own It is a first of its kind asset-financing platform that
            bridges the gap between financial institutions, customers and
            Original Equipment Manufacturers (OEMs). In line with the mission to
            ensure products and services are accessible, affordable and usable
            across Africa, we have implemented an Asset Financing technology
            solution to ensure a stable supply of assets with minimal hassles in
            order to ease your journey to acquisition.
          </p>
