...
const SignIn = () => {
    ...
    return (
        <div
            className="md:grid font-satoshi grid-cols-12 md:relative md:z-10 md:px-0 bg-light-100 h-screen overflow-y-auto overflow-x-hidden 2xl:overflow-hidden">
                ...
                <div className="h-full flex flex-col justify-center relative mx-auto lg:w-[60%]">
                    <div className="flex flex-col justify-center items-center w-full">
                        <div className="lg:px-16 md:pt-10 sm:px-20 px-4 py-10 w-full z-30 flex flex-col rounded-md modal-card">
                            <div
                                className="rounded-full p-4 mt-[-10rem] md:mt-0 md:mx-0 mx-auto md:my-0 mb-10 md:bg-transparent bg-[#F1F1F8] md:shadow-none shadow h-[100px] w-[100px] md:w-full md:h-full md:p-0 md:block flex items-center xl:h-auto xl:w-auto">
                            ...
                            <form onSubmit={handleSubmit} className="w-full text-black">
                                ...
                                <div className="mt-9 w-full">
                                    <div className="w-full justify-between flex flex-row items-center">
                                        ...
                                        <Link
                                            to="/forget-password"
                                            className="text-blue-600 text-sm hover:text-[#3c4257] ease transition-all font-medium"
                                        >
                                    ...
                                    <div className="w-full relative">
                                        ...
                                        <div onClick={() => setIsPassword(!isPassword)}>
                                            <div>
                                                <svg
                                                    className={`cursor-pointer absolute top-[1.6rem] right-[0.6rem] w-[20px] h-[20px] ${isPassword ? 'block' : 'hidden'}`}
                                                ...
                                                <svg
                                                    className={`absolute top-[1.6rem] right-[0.6rem] w-[20px] h-[20px] ${!isPassword ? 'block' : 'hidden'}`}
                                                    xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 -960 960 960" width="48">
                                                    <path
                                    ...
                                    <div className="mt-10">
                                        ...
                                        >
                                            {loginUserMutation.isLoading ? "Please wait" : "Login"}
                                            {loginUserMutation.isLoading ? (
                                                <svg className="animate-spin h-5 w-5 ml-3 fill-white"
                                                    xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 -960 960 960" width="48">
                                                    <path
            ...
            <div className="bg-login bg-cover bg-center col-span-5 relative hidden md:block">
